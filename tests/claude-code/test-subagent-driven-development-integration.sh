...
mkdir -p src test specs/work

# Create a simple implementation plan
cat > specs/work/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at specs/work/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at specs/work/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"kdd-superpowers:subagent-driven-development"' "$SESSION_FILE"; then
