...
## Is this a kdd-superpowers issue or a platform issue?
<!-- kdd-superpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without kdd-superpowers installed.

     If the problem persists without kdd-superpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without kdd-superpowers installed
